...
public class MainActivityTest {
    ...
    public void mainActivityTest() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.enterText1),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("sos t"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatButton3 = onView(
                allOf(withId(R.id.buttononoff), withText("To Flash"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatButton4 = onView(
                allOf(withId(R.id.vibrate), withText("Vibrator"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatButton5 = onView(
                allOf(withId(R.id.morse_sound), withText("To Sound"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatButton13 = onView(
                allOf(withId(R.id.longButton), withText("--"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatButton23 = onView(
                allOf(withId(R.id.deleteButton), withText("Delete"),
                        childAtPosition(
                                ...
                                8),
                        isDisplayed()));
        appCompatButton23.perform(longClick());
        ...
        ViewInteraction appCompatButton25 = onView(
                allOf(withId(R.id.back1), withText("Back"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
